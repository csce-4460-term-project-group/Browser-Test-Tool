function TestCSSVisualFormattingModel() {
    ...
    var properties = ['display', 'top', 'left', 'bottom', 'right', 'float', 'clear', 'z-index', 'direction', 'unicode-bidi', 'width', 'min-width', 'max-width', 'height', 'min-height', 'max-height', 'line-height', 'vertical-align'];
